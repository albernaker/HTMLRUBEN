<?php
	...
	if (!empty($_POST)) {
		...
		$sql = "INSERT INTO usuaris (nom_usuari, contrasenya, nom, cognoms) VALUES ('$_POST[username]', '$_POST[pass]', '$_POST[nombre]', '$_POST[apellidos]')";
		...
		<div class="container m-5 mx-auto text-white">
			<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
				<div class="col-4 offset-4">
					...
					<span class="text-danger"><?php if ($errorEnvioDatos) echo "S'ha produït un error al enviar les dades"; ?></span>
